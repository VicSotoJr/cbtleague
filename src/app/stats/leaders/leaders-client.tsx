...
const leaderCategories: Array<{
...
}> = [
  {
    ...
    items: [
      { key: "PPG", label: "Points Per Game (Min. 4 GP)", color: "from-copper-500 to-copper-700" },
      { key: "Points", label: "Total Points", color: "from-copper-600 to-copper-800" },
      { key: "ThreesMade", label: "3PM (Min. 10 Attempts)", color: "from-orange-500 to-orange-700" },
      { key: "EFF", label: "Efficiency Rating (Min. 4 GP)", color: "from-pink-500 to-pink-700" },
    ],
  },
  {
    group: "Shooting Efficiency",
    items: [
      { key: "FG%", label: "Field Goal % (Min. 20 Attempts)", color: "from-red-500 to-red-700" },
      { key: "2P%", label: "2-Point % (Min. 15 Attempts)", color: "from-red-600 to-red-800" },
      { key: "3P%", label: "3-Point % (Min. 10 Attempts)", color: "from-copper-500 to-copper-700" },
      { key: "FT%", label: "Free Throw % (Min. 10 Attempts)", color: "from-copper-600 to-copper-800" },
    ],
  },
  {
    group: "Glass & Rebounding",
    items: [
      { key: "RPG", label: "Rebounds Per Game (Min. 4 GP)", color: "from-blue-500 to-blue-700" },
      { key: "Rebounds", label: "Total Rebounds", color: "from-sky-500 to-sky-700" },
      { key: "Offrebounds", label: "Offensive (Min. 4 GP)", color: "from-cyan-500 to-cyan-700" },
      { key: "Defrebounds", label: "Defensive (Min. 4 GP)", color: "from-indigo-500 to-indigo-700" },
    ],
  },
  {
    group: "Playmaking & Control",
    items: [
      { key: "APG", label: "Assists Per Game (Min. 4 GP)", color: "from-green-500 to-green-700" },
      { key: "Assists", label: "Total Assists", color: "from-green-600 to-green-800" },
      { key: "TOVPG", label: "Turnovers / G (Min. 4 GP)", color: "from-zinc-500 to-zinc-700" },
  ...
  },
  {
    ...
    items: [
      { key: "SPG", label: "Steals Per Game (Min. 4 GP)", color: "from-purple-500 to-purple-700" },
      { key: "Steals", label: "Total Steals", color: "from-fuchsia-500 to-fuchsia-700" },
      { key: "BPG", label: "Blocks Per Game (Min. 4 GP)", color: "from-amber-500 to-amber-700" },
